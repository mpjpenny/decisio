					...
					<div class="tp_active_right_sidebar">
						<div class="tp_active_right_sidebar_wrapper">
							<ul class="tp_active_right_sidebar_list">
								...
								<li>
									<a href="http://docs.posimyth.com/tpae/" target="_blank">
								...
								<li>
									<a href="https://theplusaddons.com/changelog/" target="_blank">
								...
								<li>
									<a href="https://theplusaddons.com/#tpf-footer" target="_blank">
								...
								<li>
									<a href="https://theplusaddons.com/client-feedback-and-suggestions/" target="_blank">
		...
		return array_merge(
		 ...
		 array(
				...
				array(
					...
					'desc' => sprintf(__('Note: Generate Facebook App Secret using <a href="https://developers.facebook.com/apps" target="_blank">link</a>. This id will be used for your "Login with Facebook" feature in Login/Signup Widget.', 'theplus')),
					'default' => '',
